...
export const defaultContent: PageContentMap = {
  ...
  home: {
    ...
    promo: {
      ...
      button: { label: 'Перейти', href: '/boxes' },
    ...
    hits: {
      ...
      products: [
        ...
        { id: 'cherry', name: 'Вишнёвое', image: '/images/boxes/cookie-cherry.png' },
      ],
  ...
  hits: {
    ...
    products: [
      ...
      { id: 'biscoff', name: 'Biscoff\nLava', image: '/images/hits/product-biscoff-69b495.png' },
      { id: 'cherry', name: 'Вишнёвое', image: '/images/boxes/cookie-cherry.png' },
    ],
  },
  ...
  boxes: {
    constructor: {
      ...
      customNote: 'Индивидуальный набор можно согласовать через MAX или Telegram',
      sizes: [
  ...
  delivery: {
    ...
    schedule: [
      ...
      'Возможна доставка в день заказа при наличии свободных интервалов',
      'Точное время доставки согласовывается после оформления заказа',
    ],
    stepsTitle: 'Как это работает',
    steps: [
      'Вы собираете десерты на сайте',
      'Оставляете заявку',
      'Мы связываемся с вами для подтверждения заказа',
      'Уточняем детали заказа и рассчитываем стоимость доставки',
      'Вы оплачиваете заказ',
      'Передаём заказ курьеру',
    ],
  },
